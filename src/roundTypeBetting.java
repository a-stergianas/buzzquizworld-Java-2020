...
/**
 Κλάση που αναπαριστά το παράθυρο γύρου τύπου "Ποντάρισμα".
 …
 ...
 …
 */
public class roundTypeBetting extends JFrame {

    private JPanel panel;
    private JLabel l1,l2,l3,l4,l5,l6,l7,question,pointsLabel,image,pointsLabel1,pointsLabel2;
    private JButton answer1,answer2,answer3,answer4,betButton,answer1_1,answer2_1,answer3_1,answer4_1,answer1_2,answer2_2,answer3_2,answer4_2;
    private JComboBox betBox,betBox1,betBox2;
    private int j=0,bet=250,bet1=250,bet2=250,Flag1=0,Flag2=0;
    ...
    /**
     Κατασκευαστής της κλάσης roundTypeBetting για 1 παίκτη.
     …
     ...
     */
    public roundTypeBetting(String PlayerName,int i,int r,int q,Question[] questions,double points) {
        ...
        panel = new JPanel();
        l1 = new JLabel("Round " + (i + 1) + "/" + r + ". Round Type “Betting“");
        l2 = new JLabel("Given the category of each question you can bet 250, 500, 750 or 1000 points.");
        l3 = new JLabel();
        l4 = new JLabel();
        l5 = new JLabel();
        betBox = new JComboBox(new String[] {"250","500","750","1000"});
        ...
        betBox.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if (betBox.getSelectedItem().equals("250")){
                    bet=250;
                }
                else if (betBox.getSelectedItem().equals("500")){
                    bet=500;
                }
                else if (betBox.getSelectedItem().equals("750")){
                    bet=750;
                }
                else{
                    bet=1000;
    ...
    /**
     Κατασκευαστής της κλάσης roundTypeBetting για 2 παίκτες.
     …
     ...
     */
    public roundTypeBetting(String Player1,String Player2,int i,int r, int q, Question[] questions,double points1,double points2) {
        ...
        l4= new JLabel();
        l5= new JLabel();
        l6= new JLabel(Player1+"'s bet:");
        l7= new JLabel(Player2+"'s bet:");
        betBox1 = new JComboBox(new String[] {"250","500","750","1000"});
        betBox2 = new JComboBox(new String[] {"250","500","750","1000"});
        betButton = new JButton("BET");
        question = new JLabel();
        image = new JLabel(new ImageIcon(""));
        answer1 = new JButton();
        ...
        betBox1.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if (betBox1.getSelectedItem().equals("250")){
                    bet1=250;
                }
                else if (betBox1.getSelectedItem().equals("500")){
                    bet1=500;
                }
                else if (betBox1.getSelectedItem().equals("750")){
                    bet1=750;
                }
                else{
                    bet1=1000;
        ...
        betBox2.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if (betBox2.getSelectedItem().equals("250")){
                    bet2=250;
                }
                else if (betBox2.getSelectedItem().equals("500")){
                    bet2=500;
                }
                else if (betBox2.getSelectedItem().equals("750")){
                    bet2=750;
                }
                else{
                    bet2=1000;
    ...
    public void playQuestion(int i,Question[] questions)
    {
        ...
        l4.setText("Category “" + questions[j].getCategory() + "“. Place your bet: ");
        l5.setText("");
        if(flag){
